...
ggplot(d3, aes(months, variable, fill = value)) + geom_tile()  + facet_wrap(~journal) + scale_x_discrete(expand = c(0, 0), breaks=c(1:90, by = 5)) + scale_y_discrete(expand = c(0, 0)) + coord_flip() 
